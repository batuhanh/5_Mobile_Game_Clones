...
//////////////////////////////////////////////////////
	...
	MKFragmentOutput DepthNormalsFrag(VertexOutputDepthNormals vertexOutput)
	{
		...
		Surface surface = InitSurface(surfaceData, PASS_SAMPLER_2D(_AlbedoMap), _AlbedoColor, vertexOutput.svPositionClip);
				...
				mkFragmentOutput.svTarget0 = half4(normalWS, 0.0);
			#endif
		#else
			mkFragmentOutput.svTarget0 = half4(PackNormalOctRectEncode(SafeNormalize(mul((half3x3) MATRIX_V, vertexOutput.normalWorld).xyz)), 0.0, 0.0);
		#endif
