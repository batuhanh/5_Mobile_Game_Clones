...
public class EventManager : MonoBehaviour
{
    ...
    public delegate void HandVacuumStageDone();
    public static event HandVacuumStageDone handVacuumStageDone;
    ...
    public void CallHandVacuumStageDoneEvent()
    {
        if (handVacuumStageDone != null)
            handVacuumStageDone();
    }
