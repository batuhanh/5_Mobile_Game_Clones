...
namespace PaintIn3D
{
	...
	public abstract class P3dHitScreenBase : MonoBehaviour
	{
		...
		{
			var offset = P3dInputManager.TouchCount > 0 ? touchOffset : mouseOffset;

			if (offset != 0.0f)
			{
				screenPosition.y    += offset / P3dInputManager.ScaleFactor;
				screenPositionOld.y += offset / P3dInputManager.ScaleFactor;
			}
